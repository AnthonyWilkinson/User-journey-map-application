...
foreach ($stageRS as $Stagerow) {
    $insert = "INSERT INTO  CJ_thinking (thinkingDesc, userJourneyID) VALUES (:thinkingDesc, :userJourneyID)";
    $result = $dbConn->prepare($insert);
    $result->execute(array(':thinkingDesc' => '', ':userJourneyID' => $userJourneyID));
}
